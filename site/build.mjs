...
export async function build({ root, outDir }) {
  ...
  // src="assets/…"（header logo <img>）也要往上一層；與下方 href 規則無交互，獨立一條。
  const docsHtml = renderDocs(plugin).replaceAll('src="assets/', 'src="../assets/').replaceAll('href="assets/', 'href="../assets/').replaceAll('href="index.html"', 'href="../index.html"').replaceAll('href="changelog.html"', 'href="../changelog.html"').replaceAll('href="docs/index.html"', 'href="index.html"');
